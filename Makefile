...
LIBS = -L/home/hoop/MY_PROG_PROJECTS/AT61F/development/lib -lInfraredTempSDK -lIRNetClient -lhyvstream -ljson_linux-gcc-5.4.0_libmt -lcurl -ltiff -llzma -ldl -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio -lavcodec



#получение исполняемого файла путем компоновки объектных (пока только 1 объектный). 
compile: objectfiles
	g++  $(LFLAG) -o ./build/at61f -Wall -DVS_TRANMIST -fPIC -pthread $(INCLUDE) ./build/main.o ./build/thematic.o ./build/callbacks.o ./build/basis.o ./build/windows.o ./build/video_window.o ./build/Netabstraction.o $(LIBS)
...
objectfiles: ./sources/main.cpp ./sources/thematic.cpp ./sources/callbacks.cpp ./sources/basis.cpp ./sources/Netabstraction.cpp ./sources/windows.cpp ./sources/video_window.cpp
