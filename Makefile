...
compile: objectfiles
	g++  $(LFLAG) -o ./build/at61f -Wall -DVS_TRANMIST -fPIC -pthread $(INCLUDE) ./build/main.o ./build/thematic.o ./build/callbacks.o ./build/basis.o ./build/windows.o ./build/Netabstraction.o $(LIBS)
...
objectfiles: ./sources/main.cpp ./sources/thematic.cpp ./sources/callbacks.cpp ./sources/basis.cpp ./sources/Netabstraction.cpp ./sources/windows.cpp
